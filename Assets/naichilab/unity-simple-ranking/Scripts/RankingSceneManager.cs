...
//                    Debug.Log(r[COLUMN_SCORE].ToString());
        ...
        public void OnCloseButtonClick()
        {
            ...
            if(_lastScore.Value == -1000) UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync("RankingInTitle");
            else UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync("Ranking");

            if(_lastScore.Value != -1000)
            {
                gameManager = GameObject.Find("GameManager");
                gms = gameManager.GetComponent<GameManagerScript>();
                gms.InsGameOverPrefab();
            }
        }
