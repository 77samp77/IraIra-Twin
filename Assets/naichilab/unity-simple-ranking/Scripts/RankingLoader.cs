    ...
    public class RankingLoader : MonoBehaviour
    {
        ...
        */
        ...
        public void SendScoreAndShowRanking(double score, int boardId = 0)
        {
            ...
            SendScoreAndShowRanking(score, sc, board);
        }

        private void SendScoreAndShowRanking(double score, IScore sc, RankingInfo board)
        {
            if (board.Type != sc.Type)
            {
            ...
            LastScore = sc;
            if(score == -1000) SceneManager.LoadScene("RankingInTitle", LoadSceneMode.Additive);
            else SceneManager.LoadScene("Ranking", LoadSceneMode.Additive);
        }
    }
}